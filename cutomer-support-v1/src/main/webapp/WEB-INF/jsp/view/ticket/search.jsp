<%--@elvariable id="searchForm" type="com.my.site.TicketController.SearchForm"--%>
<%--@elvariable id="searchPerformed" type="boolean"--%>
<%--@elvariable id="results" type="org.springframework.data.domain.Page<com.my.site.repositories.SearchResult<com.my.site.entities.Ticket>>"--%>
            ...
            <c:otherwise>
                ...
                <c:forEach items="${results.content}" var="result">
                    ...
                    <a href="<c:url value="/ticket/view/${result.entity.id}" />">
                        <c:out value="${my:abbreviateString(result.entity.subject, 60)}"/>
                    </a><br />

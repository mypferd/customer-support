...
<%--@elvariable id="ticket" type="com.my.site.entities.Ticket"--%>
<%--@elvariable id="comments" type="org.springframework.data.domain.Page<com.my.site.entities.TicketComment>"--%>
